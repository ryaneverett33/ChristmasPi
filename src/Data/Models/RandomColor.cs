            ...
            if (useGenerator) {
                ...
                if (usage.HasFlag(DelegateUsage.RedDelegate)) {
                    ...
                    if (r < Constants.RANDOM_MIN || r > Constants.RANDOM_MAX - 1)
                        Log.ForContext<RandomColor>().Debug("Red delegate function returned values out of range and was clamped");
                    ...
                    if (g < Constants.RANDOM_MIN || g > Constants.RANDOM_MAX - 1)
                        Log.ForContext<RandomColor>().Debug("Green delegate function returned values out of range and was clamped");
                    ...
                    if (b < Constants.RANDOM_MIN || g > Constants.RANDOM_MAX - 1)
                        Log.ForContext<RandomColor>().Debug("Blue delegate function returned values out of range and was clamped");
