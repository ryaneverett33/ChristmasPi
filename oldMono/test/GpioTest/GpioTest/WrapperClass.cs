...
namespace WiringPi
{
    ...
    public class Init
    {
        [DllImport("libwiringPi.so.2.31", EntryPoint = "wiringPiSetup")]     //This is an example of how to call a method / function in a c library from c#
        public static extern int WiringPiSetup();

        [DllImport("libwiringPi.so.2.31", EntryPoint = "wiringPiSetupGpio")]
        public static extern int WiringPiSetupGpio();

        [DllImport("libwiringPi.so.2.31", EntryPoint = "wiringPiSetupSys")]
    ...
    public class GPIO
    {
        [DllImport("libwiringPi.so.2.31", EntryPoint = "pinMode")]           //Uses Gpio pin numbers
        public static extern void pinMode(int pin, int mode);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "digitalWrite")]      //Uses Gpio pin numbers
        public static extern void digitalWrite(int pin, int value);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "digitalWriteByte")]      //Uses Gpio pin numbers
        public static extern void digitalWriteByte(int value);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "digitalRead")]           //Uses Gpio pin numbers
        public static extern int digitalRead(int pin);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "pullUpDnControl")]         //Uses Gpio pin numbers  
        public static extern void pullUpDnControl(int pin, int pud);

        //This pwm mode cannot be used when using GpioSys mode!!
        [DllImport("libwiringPi.so.2.31", EntryPoint = "pwmWrite")]              //Uses Gpio pin numbers
        public static extern void pwmWrite(int pin, int value);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "pwmSetMode")]             //Uses Gpio pin numbers
        public static extern void pwmSetMode(int mode);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "pwmSetRange")]             //Uses Gpio pin numbers
        public static extern void pwmSetRange(uint range);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "pwmSetClock")]             //Uses Gpio pin numbers
        public static extern void pwmSetClock(int divisor);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "gpioClockSet")]              //Uses Gpio pin numbers
    ...
    public class Timing
    {
        [DllImport("libwiringPi.so.2.31", EntryPoint = "millis")]
        public static extern uint millis();

        [DllImport("libwiringPi.so.2.31", EntryPoint = "delay")]
        public static extern void delay(uint howLong);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "delayMicroseconds")]
    ...
    {
        [DllImport("libwiringPi.so.2.31", EntryPoint = "piHiPri")]
        public static extern int PiHiPri(int priority);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "waitForInterrupt")]
        ...
        [DllImport("libwiringPi.so.2.31", EntryPoint = "wiringPiISR")]
    ...
    {
        [DllImport("libwiringPi.so.2.31", EntryPoint = "piBoardRev")]
        public static extern int piBoardRev();

        [DllImport("libwiringPi.so.2.31", EntryPoint = "wpiPinToGpio")]
        public static extern int wpiPinToGpio(int wPiPin);

        [DllImport("libwiringPi.so.2.31", EntryPoint = "setPadDrive")]
